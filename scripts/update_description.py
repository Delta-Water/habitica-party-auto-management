...
handler = RotatingFileHandler('./habitica-party-auto-management/logs/update_description.log', maxBytes=1024*1024, backupCount=1)
...
def main():
    ...
    headers = {
        ...
        "x-client": HABITICA_USER_ID + "-AutomatePartyManagement",
